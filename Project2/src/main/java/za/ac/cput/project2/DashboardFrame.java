...
public class DashboardFrame extends JFrame {
    ...
    private static void addHoverEffect(JPanel card) {
    ...
    /*@Override
            public void mouseClicked(MouseEvent e) {
                // This is where you put your code for when the card is clicked.
                // The 'cardTitle' variable tells you which card was clicked.
                ...
                if (cardTitle.equals("Current Rooms")) {
                    ...
                    System.out.println("Check Availability card clicked!");
                    // Example: new CheckAvailabilityFrame().setVisible(true);
                } else if (cardTitle.equals("Book Room")) {
                    // Code for when "Book Room" is clicked
                    System.out.println("Book Room card clicked!");
                    // Example: new BookRoomFrame().setVisible(true);
                }
            }
        });
        */
